...
import Registrodependencia from "../../components/Registrodependencia";
...
const Formulario = () => {
  ...
  async function obtenerDatos() {
    const datos = await fetch("http://localhost:3000/formulario/persona");
    return datos.json();
  }
  ...
  const fetchData = async () => {
    const response = await fetch("http://localhost:3000/formulario/persona");
